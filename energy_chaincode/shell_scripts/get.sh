...
peer chaincode query -C appchannel -n energycccccc -c '{"Args":["readMarble","marble1"]}'
#peer chaincode query -C appchannel -n energycccc -c '{"Args":["getHistoryForMarble","marble1"]}'
