#!/bin/bash
# peer lifecycle chaincode checkcommitreadiness --channelID appchannel --name advertisement --version 1.0 --sequence 1 --tls --cafile /root/CLI/orgca/orderer/msp/tls/ca.crt --output json
set -x #echo on
