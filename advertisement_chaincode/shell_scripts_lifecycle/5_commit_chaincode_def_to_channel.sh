#!/bin/bash
# peer lifecycle chaincode commit -o orderer:7050 --channelID appchannel --name advertisement --version 1.0 --sequence 1 --tls --cafile /root/CLI/orgca/orderer/msp/tls/ca.crt --peerAddresses peer2:7051 --tlsRootCertFiles /root/CLI/orgca/peer2/msp/tls/ca.crt
# peer lifecycle chaincode querycommitted --channelID appchannel --name advertisement --cafile /root/CLI/orgca/orderer/msp/tls/ca.crt
set -x #echo on
...
CHAINCODE_SRC_CODE_PATH="/root/CLI/chaincodes/smart_energy_chaincodes/advertisement_chaincode/src"
