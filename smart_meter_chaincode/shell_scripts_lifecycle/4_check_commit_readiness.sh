#!/bin/bash
# peer lifecycle chaincode checkcommitreadiness --channelID appchannel --name smart-meter --version 1.0 --sequence 1 --tls --cafile /root/CLI/orgca/orderer/msp/tls/ca.crt --output json
set -x #echo on
